    ...
    <div className={cn("w-10/12 container sm:ml-10 sm:mt-20")}>
      <div className={cn("grid justify-end ")}>
        ...
        <p className="text-2xl mt-4 text-justify">
          ...
          <p>
            <span className="ml-4">При</span> заучивании слов важно регулярная
            практика, будь то ежедневное повторение или упражнение на этом
            тренажере. Но, как вы понимаете, лучшей практикой является чтение на
            английском.
          </p>
          <p>
            <span className="ml-4">Вы</span> уже наверняка гуглили "как учить
            слова на английском" или что-то подобное. Советую почитать статьи
            или книги Вячеслава Дубынина, он объясняет, как работает память, но
            если вам лень еще что-то читать, дам совет от себя: повторяйте
            заученные слова через 20 минут, потом через 8 часов, а в следующий
            раз через 20 часов, это увеличит вероятность перехода информации из
            краткосрочной в долговременную память.
          </p>
          <p>
            <span className="ml-4">Удачи</span> вам и спасибо, что пользуетесь
            моим сайтом!
          </p>
          <p>
            <span className="ml-4">Почта для фидбэка:</span>
          </p>
          <MailTo
