      ...
      <div className={cn("grid justify-end ")}>
        ...
        <p className="text-2xl mt-4 text-justify">
          ...
          <p>
            ...
            объясняет, как работает память, но если вам лень еще что-то читать,
            дам совет от себя: повторяйте заученные слова через 20 минут, потом
            через 8 часов, а в следующий раз через 20 часов, это увеличит
            вероятность перехода информации из краткосрочной в долговременную
            память.
          </p>
